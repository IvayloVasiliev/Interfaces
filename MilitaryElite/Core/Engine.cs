...
namespace MilitaryElite.Core
{
    public class Engine
    {
        ...
        private ISoldier GetEngineer(int id, string firstName, string lastName, 
            decimal salary, string[] inputArgs)
        {
            string corpsAsString = inputArgs[5];
        ...
        private ISoldier GetLieutenantGeneral(int id, string firstName, string lastName, 
            decimal salary, string[] inputArgs)
        {
